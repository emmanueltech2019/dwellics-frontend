    ...
    <div>
            ...
            <main class="home-overview-wrap">
              ...
              <section class="home-why-niche">
                ...
                <p
                  class="type--weight-700 home-header home-header--why home-header__title"
                >
                ...
                <div class="type--weight-400 home-body home-body--why">
                  We give you all of the data, reviews, and insights in one
                  place to make your search as easy as possible.
                </div>
              ...
              <section id="testimonialCarousel" class="home-testimonial">
                ...
                <div
                  class="home-testimonial__carousel home-testimonial__carousel--animatable home-testimonial__carousel--make-slides"
                >
                  ...
                  <ul class="home-testimonial__slides" id="carouselSlides">
                    ...
                    >
                      ...
                      <div
                        class="home-testimonial__quote home-testimonial__quote--abby home-testimonial__quote--debut"
                      >
                        During my college search, I was having a difficult time
                        narrowing down what I wanted in a school, so I used
                        Niche to help. I especially liked looking at the
                        rankings for different aspects of the college
                        experience, like the campus, academics, and much more!
                      </div>
                      <div
                        class="home-testimonial__quoter home-testimonial__quoter--debut"
                      >
                        Abby D.
                      </div>
                    </li>
                    <li class="home-testimonial__slide" aria-hidden="true">
                      ...
                      <div
                        class="home-testimonial__quote home-testimonial__quote--dayna"
                      >
                        I am so grateful for Niche and their resources.
                        Schooling children at home has truly had its challenges.
                        But having resources has made it so much easier. Finding
                        the right programs for my little ones has been
                        invaluable.
                      </div>
                    ...
                    <li class="home-testimonial__slide" aria-hidden="true">
                      ...
                      <div
                        class="home-testimonial__quote home-testimonial__quote--clay"
                      >
                        When I was applying to college, I had no idea what I was
                        looking for. Niche helped me explore different schools
                        and see breakdowns on many aspects of their programs!
                        Thanks to Niche, I found a school that was a perfect
                        fit!
                      </div>
              ...
              <section class="home-features">
                <div
                  class="home-background-squiggle home-background-squiggle--green"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 1512 3578.12"
                ...
                <div class="home-features__copy-container">
                  ...
                  <p
                    class="type--weight-700 home-header home-header--features home-header__title"
                  >
              ...
              <section class="home-compare">
                ...
                <div class="home-compare__copy-container">
                  ...
                  <p
                    class="type--weight-700 home-header home-header--compare home-header__title"
                  >
                  ...
                  <div class="type--weight-400 home-body home-body--compare">
                    With the information you care about on every school in
                    America, we make it easy for you to compare schools and
                    colleges to make your decision.
                  </div>
                  <ul class="home-compare__links">
                    <li class="home-compare__link">
                      <a href="https://www.niche.com/k12/compare/" tabindex="0"
                        >Compare K-12 Schools</a
                      >
                    </li>
                    <li class="home-compare__link">
                      <a
              ...
              <section class="home-rankings">
                ...
                <p
                  class="type--weight-700 home-header home-header--rankings home-header__title"
                >
              ...
              <section class="home-partners">
                ...
                <div class="home-partners__copy-container">
                  ...
                  <p
                    class="type--weight-700 home-header home-header--partners home-header__title"
                  >
                  ...
                  <div class="type--weight-400 home-body home-body--partners">
                    ...
                    about how you can partner with Niche to connect with
                  ...
                  <div class="home-partners__cta-claim">
                    <a
                      ...
                      ></span
                      ><span
                        class="type--weight-600 home-partners__cta-claim__text"
                        >Claim Your School</span
                      ></a
                    >
                  </div>
                  <div class="home-partners__cta-learn">
                    <button class="button home-button--green">
                      Learn More
                    </button>
                  </div>
                </div>
                ...
                >
                  <figure
                    class="home-partners__photo home-partners__photo--photo1"
                  >
                    ...
                    <figcaption
                      class="type--weight-600 home-partners__photo__caption"
                    >
                      Dartmouth College
                    </figcaption>
                  </figure>
                  <figure
                    class="home-partners__photo home-partners__photo--photo2"
                  >
                    <div class="home-partners__photo__image-wrap">
                      <picture
                        ><source
